  ...
  console.log(data);
    ...
    return(
        ...
        <div className="flex flex-row justify-center gap-10">
            ...
            <h1 className="text-3xl text-center text-text-inverse">Contáctanos</h1>
            <div className="flex flex-row gap-10 justify-center p-5">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-2 min-w-sm">
                    ...
                    <button type="submit" className="flex flex-row justify-center gap-2 p-2 ml-80 p-5 rounded-lg hover:scale-110 hover: transition-transform duration-300 ease-in-out bg-gradient-to-t from-surface to-surface hover:to-brand-accent cursor-pointer"> <SendHorizonal className="w-5 h-5"/></button>
                </form>
