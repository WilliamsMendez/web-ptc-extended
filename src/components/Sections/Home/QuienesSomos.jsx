...
<motion.section className="my-16 md:my-16 px-4" id="quienesSomos">
  ...
  <motion.h1 variants={fadeInBlur(1, 0.3)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-text-primary text-3xl md:text-4xl lg:text-5xl font-bold text-center">
    ¿Quiénes Somos?
  </motion.h1>

      <motion.p variants={fadeInBlur(1, 0.5)} initial="hidden" whileInView="visible" viewport={{ once: true }}  className="text-text-primary py-6 px-2 md:px-0 max-w-2xl text-center mx-auto text-base md:text-lg leading-relaxed">
