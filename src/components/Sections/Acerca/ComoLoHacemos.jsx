...
export default function ComoLoHacemos(){
    ...
    return (
        <>
            {/* T I T U L O */}
            <motion.div initial={{ opacity: 0, blur: 2 }} whileInView={{ opacity: 1, blur: 1 }} transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }} viewport={{ once: true }} className="relative flex items-center justify-center h-[250px] md:h-[400px] overflow-hidden px-6">
                <TextHoverEffectDemo texto="COMO" className="z-0" />
                <motion.h1 variants={fadeInBlur(1, 0.3)} id="comoLoHacemos" initial="hidden" whileInView="visible" viewport={{ once: true }} className="absolute top-1/2 -translate-y-1/2 text-text-primary text-3xl md:text-4xl lg:text-5xl z-10 text-center">¿Cómo lo hacemos?</motion.h1>
            </motion.div>
            {/* D I V S */}
            <motion.div variants={fadeInBlur(1, 0.3)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="my-16 px-6 md:px-10 flex flex-col md:flex-row justify-center max-w-6xl mx-auto gap-12 text-text-primary">
                <motion.div variants={fadeUp(0.6, 0.5)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col gap-5 justify-center items-center">
                    <UserRoundSearch/>
                ...
                <hr variants={fadeInBlur(0.5, 0.3)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="hidden md:block h-24 w-px border-l border-text-primary/50" />
                <hr variants={fadeInBlur(0.5, 0.3)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="block md:hidden w-24 h-px border-t border-text-primary/50 mx-auto" />

                <motion.div variants={fadeUp(0.6, 0.7)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col gap-5 justify-center items-center">
                    <Wallet/>
                ...
                <motion.div variants={fadeUp(0.6, 0.9)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col gap-5 justify-center items-center">
                    <Store/>
                ...
                <motion.div variants={fadeUp(0.6, 1.1)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col gap-5 justify-center items-center">
                    <CreditCard/>
