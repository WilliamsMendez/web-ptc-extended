...
export default function QueHacemos(){
    ...
    <motion.h1 variants={fadeInBlur(1, 0.3)} initial="hidden" whileInView="visible" className="flex justify-center text-text-primary text-4xl">
      ...
      <motion.div variants={fadeInBlur(1, 0.5)} initial="hidden" whileInView="visible" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5 px-6 md:px-10 lg:p-20">
        <QueHacemosCard className="col-span-3" descripcion="Modelos de riesgo crediticio para la aprobación y emisión de tarjetas de crédito y productos financieros" icono={<CreditCard className="h-10 w-10 rounded-full" />}/>
        <QueHacemosCard className="col-span-3" descripcion="Análisis y estrategias para el desarrollo y rentabilidad de portfolios" icono={<ChartSpline className="h-10 w-10 rounded-full"/>} />
        <QueHacemosCard className="col-span-3" descripcion="Administración y gestión comercial de medios de pagos electrónicos y otros productos financieros" icono={<HandCoins className="h-10 w-10 rounded-full"/>}/>
        <QueHacemosCard className="col-span-3" descripcion="Gestión operativa de medios de pagos electrónicos y otros servicios financieros" icono={<SmartphoneNfc className="h-10 w-10 rounded-full"/>}/>
        ...
        <QueHacemosCard className="col-span-3" descripcion="Gestión de cobranza de medios de pagos electrónicos y otros servicios financieros" icono={<BanknoteArrowDown className="h-10 w-10 rounded-full"/>}/>
