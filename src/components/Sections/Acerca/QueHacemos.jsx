...
export default function QueHacemos(){
    ...
    <motion.h1 variants={fadeInBlur(1, 0.2)} initial="hidden" whileInView="visible" viewport={{once: true}} className="flex justify-center bg-linear-to-br from-quienes-somos-top to-quienes-somos-bottom bg-clip-text text-transparent text-5xl tracking-tight">
      ...
      <motion.div variants={fadeInBlur(1, 0.5)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5 px-6 md:px-10 lg:p-20">
        <motion.div variants={fadeLeft(1, 0.7)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="col-span-3">
        ...
        <motion.div variants={fadeRight(1, 0.9)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="col-span-3">
        ...
        <motion.div variants={fadeLeft(1, 0.9)} initial="hidden" whileInView="visible" viewport={{ once: true }} className="col-span-3">
