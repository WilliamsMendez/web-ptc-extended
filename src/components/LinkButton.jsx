...
export default function LinkButton({ linkto = "", bg = "#5D8BB5", titulo = "" }) {
  return (
    <Link to={linkto} style={{ backgroundColor: bg }} className="max-w-40 mx-auto group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md px-6 font-medium text-neutral-200 duration-500 hover:scale-110">
