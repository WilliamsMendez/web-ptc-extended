    ...
    return(
        ...
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                <h2 className="text-2xl font-semibold">Tegucigalpa</h2>
                ...
                <a href="https://www.google.com/maps/d/u/0/edit?mid=168gMpTaz0zIBqxu5yRFUJ74V7q4gYVc&usp=sharing" target="_blank" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-accent text-white hover:scale-105 transition-all duration-300">Ver en Google Maps<ExternalLink className="w-4 h-4" /></a>
                </div>
