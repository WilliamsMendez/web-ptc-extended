  ...
  return (
    <motion.div
      ...
      className={`row-span-${rowSpan} relative bg-surface rounded-2xl p-7 overflow-hidden
            ...
            after:bg-[linear-gradient(180deg,rgba(var(--surface-90),0.4),transparent)] flex flex-col gap-4 drop-shadow hover:scale-105 transition border-1 border-black/10`}
    >
      <div className="flex flex-col">
        <h1 className={`bg-linear-to-br from-brand-accent-80 to-brand-accent-110 bg-clip-text text-transparent text-${textSize} font-bold`}>
          {title}
        </h1>
        <h2 className="text-text-primary/50">{subtitle}</h2>
      </div>
